...
namespace DataLayer
{
    public class ContactRepositorySP : IContactRepository
    {
        ...
        public void Save(Contact contact)
        {
            ...
            var parameters = SetParameters(contact);
            ...
            foreach( var addr in contact.Addresses.Where(a => !a.IsDeleted))
            {
                ...
                var addrParams = SetAddressParameters(addr);
        ...
        private DynamicParameters SetParameters (Contact contact)
        {
        ...
        private DynamicParameters SetAddressParameters(Address address)
        {
            DynamicParameters parameters = new DynamicParameters();
            parameters.Add("@ContactId", address.ContactId);
