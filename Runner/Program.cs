...
namespace Runner
{
    class Program
    {
        ...
        static void Find_should_retrieve_existing_entity(int id)
        {
            ...
            Debug.Assert(contact.LastName == "Swanson");
        ...
        static int Insert_should_assign_identity_to_new_entity()
        {
            ...
            var contact = new Contact()
            {
                FirstName = "Joe",
                LastName = "Swanson",
                Email = "swanson.cop@familyguy.org",
                Company = "Family Guy",
                Title = "Actor"
            };
            ...
            {
                AddressType = "Home",
                StreetAddress = "123 Spoone Street",
                City = "Quahog",
                StateId = 44,
                PostalCode = "22222"
            };
        ...
        static void Modify_should_update_existing_entity(int id)
        {
            ...
            contact.Addresses[0].StreetAddress = "465 Main Street";
            ...
            Debug.Assert(modifiedContact.Addresses.First().StreetAddress == "465 Main Street");
        }
